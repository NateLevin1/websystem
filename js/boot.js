...
function boot() {
    ...
    if(!name) {
        ...
        createButton.onclick = ()=>{
            ...
            // Set Filesystem
            localStorage.setItem('folders', '[usr]{Documents,Applications,Downloads} [Documents]{WebSystem} [Applications]{file::Calculator.app,file::App Store.app} [Downloads]{} [WebSystem]{file::logo.png}');
