  ...
  class Music {
    constructor(name="", path="") {
        ...
        if(name && path) { // open player
            win = new Window(390, 142, "Music", 390/em, 142/em, {x: 20, y: 2.2, topBarCreator: this.createTopBar, thisContext: this, appName: "Music Player - "+name, pathToApp: "/Users/"+NAME+"/Applications/Music.app/"});
